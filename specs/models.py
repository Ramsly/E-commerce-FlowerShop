...
class FeatureValidator(models.Model):
    ...
    category = models.ForeignKey("mainapp.Category", verbose_name='Категория', on_delete=models.CASCADE, blank=True, null=True, default="")
    feature_key = models.ForeignKey(CategoryFeature, verbose_name='Ключ характеристики', on_delete=models.CASCADE, blank=True, null=True, default="")
...
class ProductFeatures(models.Model):
    ...
    product = models.ForeignKey("mainapp.Product", verbose_name='Товар', on_delete=models.CASCADE, blank=True, null=True, default="")
    feature = models.ForeignKey(CategoryFeature, verbose_name='Характеристика', on_delete=models.CASCADE, blank=True, null=True, default="")
